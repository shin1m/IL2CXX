...
namespace Demos
{
    public abstract class Demo : IAsyncDisposable
    {
        /// <summary>
        ...
        public virtual Task LoadGraphicalContentAsync(WebGLContext context, ContentArchive content) => Task.CompletedTask;

        public abstract void Initialize(ContentArchive content, Camera camera);

        public const float TimestepDuration = 1 / 60f;
        public virtual void Update(Renderer renderer, Camera camera, Input input, float dt)
        {
