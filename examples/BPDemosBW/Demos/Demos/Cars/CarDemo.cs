...
namespace Demos.Demos.Cars
{
    public class CarDemo : Demo
    {
        ...
        public override void Render(Renderer renderer, Camera camera, Input input, TextBuilder text, Font font)
        {
            ...
            var textHeight = 16;
            var position = new Vector2(32, renderer.Height - 128);
            ...
            RenderControl(ref position, textHeight, nameof(ToggleCar), ToggleCar, text, renderer.TextBatcher, font);
