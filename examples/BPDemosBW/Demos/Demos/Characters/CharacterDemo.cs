...
namespace Demos.Demos.Characters
{
    ...
    public class CharacterDemo : Demo
    {
        ...
        public CharacterDemo() => characters = new(BufferPool);
        ...
        private readonly MovingPlatform[] movingPlatforms = new MovingPlatform[16];
        ...
        {
            float textHeight = 16;
            var position = new Vector2(32, renderer.Height - textHeight * 9);
