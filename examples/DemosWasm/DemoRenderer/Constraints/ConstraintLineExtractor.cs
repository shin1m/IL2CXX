...
{
    interface IConstraintLineExtractor<TPrestep>
    {
        int LinesPerConstraint { get; }

        unsafe void ExtractLines(ref TPrestep prestepBundle, int setIndex, int* bodyLocations, Bodies bodies, ref Vector3 tint, ref QuickList<LineInstance> lines);
    }
        ...
        where T : struct, IConstraintLineExtractor<TPrestep>
    {
        ...
        public override unsafe void ExtractLines(Bodies bodies, int setIndex, ref TypeBatch typeBatch, int constraintStart, int constraintCount,
