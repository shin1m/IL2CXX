...
namespace DemoRenderer.ShapeDrawing
{
    ...
    public class ShapesExtractor : IDisposable
    {
        ...
        public ShapesExtractor(GL context, ParallelLooper looper, BufferPool pool, int initialCapacityPerShapeType = 1024)
        {
        ...
        public void Initialize() => MeshCache.Initialize();
