...
namespace Demos
{
    ...
    public class DemoSet
    {
        ...
        {
            public string Name;
            public Func<GL, ContentArchive, Camera, Demo> Builder;
        }
        ...
        void AddOption<T>() where T : Demo, new()
        {
            ...
            {
                Builder = (context, content, camera) =>
                {
                    ...
                    try
                    {
                        demo.LoadGraphicalContent(context, content);
        ...
        public Demo Build(GL context, int index, ContentArchive content, Camera camera)
        {
