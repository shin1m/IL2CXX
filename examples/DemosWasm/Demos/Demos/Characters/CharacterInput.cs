...
namespace Demos.Demos.Characters
{
    ...
    public struct CharacterInput
    {
        ...
        const string MoveForward = "KeyW";
        const string MoveBackward = "KeyS";
        const string MoveRight = "KeyD";
        const string MoveLeft = "KeyA";
        const string Sprint = "ShiftLeft";
        const string Jump = "Space";
        const string JumpAlternate = "Backspace"; //I have a weird keyboard.
        ...
        {
            RenderControl(ref position, textHeight, nameof(MoveForward), MoveForward, text, textBatcher, font);
            RenderControl(ref position, textHeight, nameof(MoveBackward), MoveBackward, text, textBatcher, font);
            RenderControl(ref position, textHeight, nameof(MoveRight), MoveRight, text, textBatcher, font);
            RenderControl(ref position, textHeight, nameof(MoveLeft), MoveLeft, text, textBatcher, font);
            RenderControl(ref position, textHeight, nameof(Sprint), Sprint, text, textBatcher, font);
            RenderControl(ref position, textHeight, nameof(Jump), Jump, text, textBatcher, font);
        }
