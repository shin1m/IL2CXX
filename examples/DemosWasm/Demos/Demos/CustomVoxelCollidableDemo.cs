...
namespace Demos.Demos
{
    ...
    struct Voxels : IHomogeneousCompoundShape<Box, BoxWide>
    {
        ...
        struct HitLeafTester<T> : IRayLeafTester where T : IShapeRayHitHandler
        {
            public QuickList<Vector3> VoxelIndices;
            public Vector3 VoxelSize;
        ...
        public unsafe readonly void FindLocalOverlaps<TOverlaps>(in Vector3 min, in Vector3 max, in Vector3 sweep, float maximumT, BufferPool pool, Shapes shapes, void* overlaps) where TOverlaps : ICollisionTaskSubpairOverlaps
        {
    ...
    public struct CompoundVoxelsContinuations<TCompoundA> : ICompoundPairContinuationHandler<NonconvexReduction>
