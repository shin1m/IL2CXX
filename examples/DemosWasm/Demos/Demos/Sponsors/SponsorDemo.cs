...
namespace Demos.Demos.Sponsors
{
    ...
    public class SponsorDemo : Demo
    {
        ...
        RenderableImage CreateRewardImage(GL context, string rewardImagePath, ContentArchive content)
        {
            var textureContent = content.Load<Texture2DContent>(rewardImagePath);
            return new RenderableImage(context, textureContent);
        }
        void Add(GL context, List<Sponsor> sponsors, string name, string rewardImagePath, ContentArchive content)
        {
            Sponsor sponsor;
            sponsor.RewardImage = CreateRewardImage(context, rewardImagePath, content);
            sponsor.Name = name;
            sponsors.Add(sponsor);
        }
        public override void LoadGraphicalContent(GL context, ContentArchive content)
        {
            ...
            Add(context, sponsors1, "Y. V.", @"Content\Sponsors\smugturt.png", content);
            Add(context, sponsors1, "R. S. K.", @"Content\Sponsors\squidhanginout.png", content);
            Add(context, sponsors1, "Gavin-Williams", @"Content\Sponsors\angerybite.png", content);
            Add(context, sponsors1, "N.", @"Content\Sponsors\normalgiraffe.png", content);
            Add(context, sponsors1, "M. H.", @"Content\Sponsors\tarbeenus.png", content);
            Add(context, sponsors1, "K. C.", @"Content\Sponsors\physquirrel.png", content);
            Add(context, sponsors1, "P. S.", @"Content\Sponsors\borb.png", content);
            Add(context, sponsors1, "A different P. S.", @"Content\Sponsors\pleasedfrog.png", content);
            Add(context, sponsors1, "E. C.", @"Content\Sponsors\disturbingkoala.png", content);
            Add(context, sponsors1, "L. K. L.", @"Content\Sponsors\bork.png", content);
            Add(context, sponsors1, "A. L.", @"Content\Sponsors\waryoctopus.png", content);
            Add(context, sponsors1, "D. P.", @"Content\Sponsors\contentsluginthevoid.png", content);
            Add(context, sponsors1, "Creative-House.org", @"Content\Sponsors\handicat.png", content);
            Add(context, sponsors1, "vietnt", @"Content\Sponsors\raisondetre.png", content);
            Add(context, sponsors1, "demiurghg", @"Content\Sponsors\ifiwereatardigrade.png", content);
            ...
            Add(context, sponsors2, @"M. T.", @"Content\Sponsors\goose.png", content);
            Add(context, sponsors2, @"Yo Mamma wants you to go to bed", @"Content\Sponsors\spide.png", content);
            Add(context, sponsors2, @"A. R.", @"Content\Sponsors\scootybun.png", content);
            Add(context, sponsors2, @"Alex 'mcmonkey' Goodwin, @mcmonkey4eva on github and twitter", @"Content\Sponsors\mcmonkey.png", content);
            Add(context, sponsors2, @"A. K. D.", @"Content\Sponsors\behattedpenguin.png", content);
            Add(context, sponsors2, @"Cornmaiden xoxoxo", @"Content\Sponsors\healthyostrich.png", content);
            Add(context, sponsors2, @"F.", @"Content\Sponsors\tootbush.png", content);
            ...
            Add(context, sponsors3, @"Neos VR", @"Content\Sponsors\spooky.png", content);
        }
