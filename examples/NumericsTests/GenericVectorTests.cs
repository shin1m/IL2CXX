...
namespace System.Numerics.Tests
{
    ...
    public unsafe class GenericVectorTests
    {
        ...
        private void TestConstructor<T>() where T : struct, INumber<T>
        {
        ...
        private void TestConstructorWithOffset<T>() where T : struct, INumber<T>
        {
        ...
        private void TestConstructorConstantValue<T>() where T : struct, INumber<T>
        {
        ...
        private void TestConstructorArrayTooSmallException<T>() where T : struct, INumber<T>
        {
        ...
        private void TestConstructorWithSpan<T>() where T : struct, INumber<T>
        {
        ...
        private void TestReadOnlySpanBasedConstructorWithLessElements<T>() where T : struct, INumber<T>
        {
        ...
        private void TestSpanBasedConstructorWithLessElements<T>() where T : struct, INumber<T>
        {
            T[] values = GenerateRandomValuesForVector<T>(Vector<T>.Count - 1).ToArray();
        ...
        private void TestArrayBasedConstructor<T>() where T : struct, INumber<T>
        {
        ...
        private void TestArrayIndexBasedConstructor<T>() where T : struct, INumber<T>
        {
        ...
        private void TestArrayBasedConstructorWithLessElements<T>() where T : struct, INumber<T>
        {
            T[] values = GenerateRandomValuesForVector<T>(Vector<T>.Count - 1).ToArray();
        ...
        private void TestArrayIndexBasedConstructorLessElements<T>() where T : struct, INumber<T>
        {
            T[] values = GenerateRandomValuesForVector<T>(Vector<T>.Count * 2).ToArray();
        ...
        private void TestCopyTo<T>() where T : struct, INumber<T>
        {
        ...
        private void TestCopyToWithOffset<T>() where T : struct, INumber<T>
        {
        ...
        private void TestCopyToSpan<T>() where T : struct, INumber<T>
        {
        ...
        private void TestTryCopyToSpan<T>() where T : struct, INumber<T>
        {
            T[] initialValues = GenerateRandomValuesForVector<T>();
            var vector = new Vector<T>(initialValues);
            Span<T> destination = new T[Vector<T>.Count];
        ...
        private void TestEqualsObject<T>() where T : struct, INumber<T>
        {
            T[] values = GenerateRandomValuesForVector<T>();
        ...
        private void TestGetHashCode<T>() where T : struct, INumber<T>
        {
            T[] values = GenerateRandomValuesForVector<T>();
        ...
        private void TestToString<T>(string format, IFormatProvider provider) where T : struct, INumber<T>
        {
        ...
        private void TestAdditionOverflow<T>() where T : struct, INumber<T>
        {
            ...
            ValidateVector(sum,
                (index, val) =>
                {
                    ...
                    Assert.Equal(Util.Subtract(Util.Add(secondVector[index], minValue), T.CreateTruncating(1)), sum[index]);
                });
        }
        ...
        private void TestSubtractionOverflow<T>() where T : struct, INumber<T>
        {
            ...
            ValidateVector(difference,
                (index, val) =>
                {
                    ...
                    Assert.Equal(Util.Add(Util.Subtract(maxValue, secondVector[index]), T.CreateTruncating(1)), val);
                });
        }
        ...
        private void TestDivisionByZeroException<T>() where T : struct, INumber<T>
        {
            T[] values1 = GenerateRandomValuesForVector<T>();
        ...
        private void TestBitwiseAndOperator<T>() where T : struct, INumber<T>
        {
            T[] values1 = GenerateRandomValuesForVector<T>();
        ...
        private void TestBitwiseOrOperator<T>() where T : struct, INumber<T>
        {
            T[] values1 = GenerateRandomValuesForVector<T>();
            Vector<T> randomVector = new Vector<T>(values1);
            Vector<T> zeroVector = Vector<T>.Zero;
        ...
        private void TestBitwiseXorOperator<T>() where T : struct, INumber<T>, IBitwiseOperators<T,T,T>
        {
            T[] values1 = GenerateRandomValuesForVector<T>();
            T[] values2 = GenerateRandomValuesForVector<T>();
        ...
        private void TestBitwiseOnesComplementOperator<T>() where T : struct, INumber<T>, IBitwiseOperators<T,T,T>
        {
            T[] values1 = GenerateRandomValuesForVector<T>();
            Vector<T> randomVector1 = new Vector<T>(values1);
        ...
        private void TestBitwiseAndNot<T>() where T : struct, INumber<T>, IBitwiseOperators<T,T,T>
        {
            T[] values1 = GenerateRandomValuesForVector<T>();
            T[] values2 = GenerateRandomValuesForVector<T>();
            Vector<T> randomVector1 = new Vector<T>(values1);
        ...
        private void TestVectorGreaterThanAny<T>() where T : struct, INumber<T>
        {
            T[] values1 = new T[Vector<T>.Count];
            for (int g = 0; g < Vector<T>.Count; g++)
            {
                //values1[g] = (T)(dynamic)(g + 10);
                values1[g] = T.CreateTruncating(g + 10);
            }
            Vector<T> vec1 = new Vector<T>(values1);
            ...
            for (int g = 0; g < Vector<T>.Count; g++)
            {
                ...
                values2[g] = T.CreateTruncating(g * 5 + 9);
            }
            Vector<T> vec2 = new Vector<T>(values2);
            ...
            for (int g = 0; g < Vector<T>.Count; g++)
            {
                ...
                values3[g] = T.CreateTruncating(g + 12);
            }
        ...
        private void TestVectorGreaterThanAll<T>() where T : struct, INumber<T>
        {
            T[] values1 = new T[Vector<T>.Count];
            for (int g = 0; g < Vector<T>.Count; g++)
            {
        ...
        private void TestVectorGreaterThanOrEqualAny<T>() where T : struct, INumber<T>
        {
            ...
            for (int g = 0; g < Vector<T>.Count; g++)
            {
                ...
                values1[g] = T.CreateTruncating(g * halfStep);
            }
            Vector<T> vec1 = new Vector<T>(values1);
            ...
            for (int g = 0; g < Vector<T>.Count; g++)
            {
                ...
                values2[g] = T.CreateTruncating(g * maxStep);
            }
            Vector<T> vec2 = new Vector<T>(values2);
            ...
            for (int g = 0; g < Vector<T>.Count; g++)
            {
                ...
                values3[g] = T.CreateTruncating((g + 1) * maxStep);
            }
            Vector<T> vec3 = new Vector<T>(values3);
        ...
        private void TestVectorGreaterThanOrEqualAll<T>() where T : struct, INumber<T>
        {
            int maxT = GetMaxValue<T>();
            double maxStep = (double)maxT / (double)Vector<T>.Count;
            double halfStep = maxStep / 2;
        ...
        private void TestVectorLessThanAny<T>() where T : struct, INumber<T>
        {
            ...
            for (int g = 0; g < Vector<T>.Count; g++)
            {
                ...
                values1[g] = T.CreateTruncating(g);
            }
            Vector<T> vec1 = new Vector<T>(values1);
        ...
        private void TestVectorLessThanAll<T>() where T : struct, INumber<T>
        {
            ...
            for (int g = 0; g < Vector<T>.Count; g++)
            {
                ...
                values2[g] = T.CreateTruncating(g + 25);
            }
            Vector<T> vec2 = new Vector<T>(values2);
        ...
        private void TestVectorLessThanOrEqualAny<T>() where T : struct, INumber<T>
        {
            T[] values1 = new T[Vector<T>.Count];
            for (int g = 0; g < Vector<T>.Count; g++)
            {
            ...
            for (int g = 0; g < Vector<T>.Count; g++)
            {
                ...
                values2[g] = T.CreateTruncating(g * 2);
            }
            Vector<T> vec2 = new Vector<T>(values2);
            ...
            for (int g = 0; g < Vector<T>.Count; g++)
            {
                ...
                values3[g] = T.CreateTruncating(g + 2);
            }
            Vector<T> vec3 = new Vector<T>(values3);
        ...
        private void TestVectorLessThanOrEqualAll<T>() where T : struct, INumber<T>
        {
            T[] values1 = new T[Vector<T>.Count];
            for (int g = 0; g < Vector<T>.Count; g++)
            {
        ...
        private void TestConstructorSingleValueReflection<T>() where T : struct, INumber<T>
        {
        ...
        private void TestConstructorArrayReflection<T>() where T : struct, INumber<T>
        {
            ConstructorInfo constructor = typeof(Vector<T>).GetTypeInfo().DeclaredConstructors
                .Where(ci => ci.GetParameters().Select(pi => pi.ParameterType).SequenceEqual(new Type[] { typeof(T[]) }))
                .Single();
        ...
        private void TestCopyToReflection<T>() where T : struct, INumber<T>
        {
        ...
        private void TestCopyToWithOffsetReflection<T>() where T : struct, INumber<T>
        {
            MethodInfo copyToMethod = typeof(Vector<T>).GetTypeInfo().GetDeclaredMethods("CopyTo")
        ...
        private unsafe void TestCastToInt<T>() where T : unmanaged, INumber<T>
        {
            T[] values = GenerateRandomValuesForVector<T>();
            Vector<T> vector1 = new Vector<T>(values);
        ...
        private unsafe void TestAs<TFrom, TTo>() where TFrom : unmanaged, INumber<TFrom> where TTo : unmanaged
        {
        ...
        private static void TestSum<T>(Func<T[], T> expected) where T : struct, IEquatable<T>, INumber<T>
        {
            T[] values = GenerateRandomValuesForVector<T>();
        ...
        internal static T[] GenerateRandomValuesForVector<T>(int? numValues = null) where T : struct, INumber<T>
        {
